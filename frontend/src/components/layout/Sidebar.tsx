...
import {
  ...
  LogOut, Anchor, ChevronLeft, ChevronRight, Wallet, Globe, MessageSquare, Ship, Package, ClipboardList, CheckSquare
} from 'lucide-react';
...
const navItems = [
  ...
  { key: 'products', path: '/products', icon: Package, adminOnly: true },
